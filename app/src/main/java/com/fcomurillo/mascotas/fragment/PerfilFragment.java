...
import com.fcomurillo.mascotas.adapter.MascotaAdapter2;
...
public class PerfilFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listaContactos = v.findViewById(R.id.rvMascotas2);
    ...
    public void inicializarAdaptador() {
        MascotaAdapter2 adaptador = new MascotaAdapter2(contactos, getActivity());
